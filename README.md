...
See [instructions](https://www.whonix.org/wiki/Dev/Build_Documentation/anon-ws-dns-conf). (Replace `package-name` with the actual name of this package.)
...
`anon-ws-dns-conf` requires [donations](https://www.whonix.org/wiki/Donate) to stay alive!
